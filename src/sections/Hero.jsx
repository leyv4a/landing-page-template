...
export default function Hero() {
  ...
  return (
    <>
    <main className={` w-[95vw] md:w-[65vw] h-[90vh] text-foreground mx-auto flex flex-col gap-6 items-center  justify-start font-sans mt-3 md:mt-28`}>
        ...
        <motion.p className='text-center font-main'
          initial="hidden"
          animate="visible"
          variants={variants}
          transition={{ delay: 5}}
